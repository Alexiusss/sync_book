...
public class BookTestData {
    ...
    public static final String BOOK_LANGUAGE = "ru";
    public static final String BOOK_TRANSLATOR = "Book 1 translator";
    public static final String BOOK_NARRATOR = "Book 1 narrator";
    public static final BookTo BOOK1 = new BookTo(BOOK1_ID, BOOK_NAME, AUTHOR_NAME, "Book 1 description", PUBLICATION_YEAR, "http://book1source.com/book1.fb2", "http://book1image.com", FileType.TEXT, BOOK_LANGUAGE, BOOK_NARRATOR, BOOK_TRANSLATOR, Genre.DETECTIVE, PUBLISHER1_ID);
    public static final BookTo BOOK2 = new BookTo(BOOK2_ID, "Book 2", "Book 2 author", "Book 2 description", 2022, "http://book2source.com/book2.mp2", "http://book2image.com", FileType.AUDIO, "ru", null, null, Genre.HISTORY, PUBLISHER2_ID);
    public static final BookTo BOOK3 = new BookTo(BOOK3_ID, "Book 3", "Book 3 author", "Book 3 description", 2023, "http://book3source.com/book3.epub", "http://book3image.com", FileType.TEXT, "en", null, null, Genre.FANTASY, PUBLISHER3_ID);
